...
public class Events {
    ...
    public static final int DEPARTURE_EVENT_FIRST_PERQUISITION = 10;
    ...
    public static final int DEPARTURE_EVENT_SECOND_PERQUISITION = 10;
    ...
    public static final int ALL_EVENTS_FIRST_PERQUISITION = ARRIVAL_EVENT_FIRST_PERQUISIION + DEPARTURE_EVENT_FIRST_PERQUISITION + ABANDON_EVENT_FIRST_PERQUISITION + SKIP_EVENT_FIRST_PERQUISITION;
    public static final int ALL_EVENTS_TURNSTILES = ARRIVAL_EVENT_TURNSTILES + DEPARTURE_EVENT_TURNSTILES ;
    public static final int ALL_EVENTS_SECOND_PERQUISITION = ARRIVAL_EVENT_SECOND_PERQUISIION + DEPARTURE_EVENT_SECOND_PERQUISITION + ABANDON_EVENT_SECOND_PERQUISITION + SKIP_EVENT_SECOND_PERQUISITION;
